...
interface PerformanceCaseFilterProps {
  filters: PerformanceCaseFilters;
  onFilterApply: (filters: PerformanceCaseFilters) => void;
  onFilterReset: () => void;
}

export const PerformanceFilter: React.FC<PerformanceCaseFilterProps> = ({
  filters,
  onFilterApply,
  onFilterReset,
}) => {
        ...
        return (
          <>
            ...
            <FilterDateItem
              ...
              header="Review From"
              activeFilter={activeFilter}
              appliedFilters={filters.reviewFromFilter.appliedFilters}
              onLabelClick={(label) => handleActiveChange(label)}
              onApply={(newAppliedFilters) => {
                onFilterApply({
                  ...filters,
                  reviewFromFilter: {
                    ...filters.reviewFromFilter,
                    appliedFilters: newAppliedFilters,
                  },
                });
              }}
            ...
            <FilterDateItem
              ...
              header="Review To"
              activeFilter={activeFilter}
              appliedFilters={filters.reviewToFilter.appliedFilters}
              onLabelClick={(label) => handleActiveChange(label)}
              onApply={(newAppliedFilters) => {
                onFilterApply({
                  ...filters,
                  reviewToFilter: {
                    ...filters.reviewToFilter,
                    appliedFilters: newAppliedFilters,
                  },
                });
              }}
