...
export const useTableColumns = ({
  ...
  const tableColumns = useMemo(() => {
    ...
    const cols: CasesTableColumns = [
      ...
      {
        headerName: "Review From",
        field: "reviewFrom",
        align: "center",
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.reviewFrom
              ? moment(data.specificDetails.reviewFrom).format("DD MMM YYYY")
              : "-"}
          </Typography>
        ),
        headCellClassName: styles.ReviewColumn,
        bodyCellClassName: styles.ReviewColumn,
      },
      {
        ...
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.reviewTo
              ? moment(data.specificDetails.reviewTo).format("DD MMM YYYY")
              : "-"}
          </Typography>
        ),
        headCellClassName: styles.ReviewColumn,
