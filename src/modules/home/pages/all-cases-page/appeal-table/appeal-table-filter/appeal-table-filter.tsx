...
interface AppealCaseFilterProps {
  filters: AppealCaseFilters;
  onFilterApply: (filters: AppealCaseFilters) => void;
  onFilterReset: () => void;
}

export const AppealFilter: React.FC<AppealCaseFilterProps> = ({
  filters,
  onFilterApply,
  onFilterReset,
}) => {
      ...
      {({ toggleDrawer, handleActiveChange, activeFilter }) => {
        return (
          <>
            ...
            <FilterDateItem
              label="Appeal Date"
              header="Select Appeal Date"
              activeFilter={activeFilter}
              appliedFilters={filters.appealDateFilter.appliedFilters}
              onLabelClick={(label) => handleActiveChange(label)}
              onApply={(newAppliedFilters) => {
                onFilterApply({
                  ...filters,
                  appealDateFilter: {
                    ...filters.appealDateFilter,
                    appliedFilters: newAppliedFilters,
                  },
                });
              }}
