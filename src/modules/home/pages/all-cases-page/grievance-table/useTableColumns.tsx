...
export const useTableColumns = ({
  ...
  const tableColumns = useMemo(() => {
    ...
    const cols: CasesTableColumns = [
      ...
      {
        headerName: "Date Of Grievance Raised",
        field: "dateGrievanceRaised",
        align: "center",
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.dateGrievanceRaised
              ? moment(data.specificDetails.dateGrievanceRaised).format(
                  "DD MMM YYYY"
                )
              : "-"}
          </Typography>
        ),
        headCellClassName: styles.GrievanceDateColumn,
        bodyCellClassName: styles.GrievanceDateColumn,
      },
      {
        headerName: "Date Of Grievance Hearing",
        field: "dateGrievanceHearing",
        align: "center",
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.dateGrievanceHearing
              ? moment(data.specificDetails.dateGrievanceHearing).format(
                  "DD MMM YYYY"
                )
              : "-"}
          </Typography>
      ...
      {
        headerName: "Reason For Grievance",
        field: "reason",
        align: "center",
        disableSort: true,
        render: (data) => (
        ...
        headCellClassName: styles.GrievanceReasonColumn,
        bodyCellClassName: styles.GrievanceReasonColumn,
      },
