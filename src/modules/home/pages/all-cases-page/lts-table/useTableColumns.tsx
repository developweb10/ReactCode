  ...
  const tableColumns = useMemo(() => {
    ...
    const cols: CasesTableColumns = [
      ...
      },
      {
        ...
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.ailment}
          </Typography>
        ),
        headCellClassName: styles.AilmentColumn,
        bodyCellClassName: styles.AilmentColumn,
      },
      {
        headerName: "Fit Note Expires On",
        field: "fitNoteExpiresOn",
        align: "center",
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.fitNoteExpiresOn
              ? moment(data.specificDetails.fitNoteExpiresOn).format(
                  "DD MMM YYYY"
                )
              : "-"}
          </Typography>
        ),
        headCellClassName: styles.FitNoteColumn,
        bodyCellClassName: styles.FitNoteColumn,
      },
      {
        headerName: "Time Off Sick",
        field: "dateOfSickness",
        align: "center",
        reversedSort: true,
        render: (data) => (
          <Typography className="table-text">
            {howAgoDateDifference(
              moment(data.specificDetails.dateOfSickness)
                .startOf("day")
                .toDate(),
        ...
        headCellClassName: styles.SickDurationColumn,
        bodyCellClassName: styles.SickDurationColumnBody,
      },
    ...
    return cols;
  }, [tab, history, handleCaseViewClick, handleCaseDeleteClick]);
  return tableColumns;
};
