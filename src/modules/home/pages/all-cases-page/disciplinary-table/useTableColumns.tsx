...
export const useTableColumns = ({
  ...
  const tableColumns = useMemo(() => {
    ...
    const cols: CasesTableColumns = [
      ...
      {
        headerName: "Date Of Disciplinary",
        field: "discipliningDate",
        align: "center",
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.discipliningDate
              ? moment(data.specificDetails.discipliningDate).format(
                  "DD MMM YYYY"
                )
              : "-"}
          </Typography>
        ),
        headCellClassName: styles.DisciplinaryColumn,
        bodyCellClassName: styles.DisciplinaryColumn,
      },
      {
