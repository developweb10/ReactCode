...
interface InvestigationCaseFilterProps {
  filters: InvestigationCaseFilters;
  onFilterApply: (filters: InvestigationCaseFilters) => void;
  onFilterReset: () => void;
}

export const InvestigationFilter: React.FC<InvestigationCaseFilterProps> = ({
  filters,
  onFilterApply,
  onFilterReset,
}) => {
        ...
        return (
          <>
            ...
            <FilterDateItem
              ...
              header="Select Investigation Date"
              activeFilter={activeFilter}
              appliedFilters={filters.investigationDateFilter.appliedFilters}
              onLabelClick={(label) => handleActiveChange(label)}
              onApply={(newAppliedFilters) => {
                onFilterApply({
                  ...filters,
                  investigationDateFilter: {
                    ...filters.investigationDateFilter,
                    appliedFilters: newAppliedFilters,
                  },
                });
              }}
