  ...
  const tableColumns = useMemo(() => {
    ...
    const cols: CasesTableColumns = [
      ...
      },
      {
        ...
        headCellClassName: styles.CurrentIssueColumn,
        bodyCellClassName: styles.CurrentIssueColumn,
      },
      {
        ...
        render: (data) => (
          <Typography className="table-text">
            {data.specificDetails.investigationDate
              ? moment(data.specificDetails.investigationDate).format(
                  "DD MMM YYYY"
                )
              : "-"}
          </Typography>
        ),
        headCellClassName: styles.InvestigationColumn,
        bodyCellClassName: styles.InvestigationColumn,
      },
      {
        ...
        render: (data) => (
          <ValidIcon
            ...
            variant={data.specificDetails.suspended ? "check" : "cross"}
          />
        ),
        headCellClassName: styles.SuspendedColumn,
        bodyCellClassName: styles.SuspendedColumn,
      },
